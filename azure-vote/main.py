...
logger.addHandler(AzureEventHandler(connection_string='InstrumentationKey=177c8ebe-50b7-4300-aa6f-5202197c5991'))
...
middleware = FlaskMiddleware(
   app,
   exporter=AzureExporter(connection_string="InstrumentationKey=177c8ebe-50b7-4300-aa6f-5202197c5991"),
